...
with col2:
    ...
    #     if st.session_state.usd>buy_price:
    #         if st.button("buy"):
    #             st.session_state.usd=st.session_state.usd-buy_price
    #             if select=="삼성전자":        
    #                 st.session_state.samsung=st.session_state.samsung+float(stocks)
    #                 wallet.write("당신의 지갑:"+f'{st.session_state.usd:,.2f}'+"원")
    #                 your_stocks.write(
    # "니꺼:<br>삼성:" + str(st.session_state.samsung) +
    # "<br>비트코인:" + str(st.session_state.bitcoin) +
    ...
    # buy_price=float(price.replace(',',''))*float(stocks)
    #     select_dict={'삼성전자': st.session_state.samsung, '비트코인': st.session_state.bitcoin, 'S&P500': st.session_state.SP500, 'LG전자': st.session_state.lg, 'HMM': st.session_state.hmm}
    #     if select_dict[select]>stocks:
    #         if st.button("sell"):
    #             select_dict[select]=select_dict[select]-stocks
    #             st.session_state.usd=st.session_state.usd+sell_price
    #             wallet.write("당신의 지갑:"+f'{st.session_state.usd:,.2f}'+"원")
    #             your_stocks.write(
    # "니꺼:<br>삼성:" + str(st.session_state.samsung) +
    # "<br>비트코인:" + str(st.session_state.bitcoin) +
    ...
    # "<br>LG전자" + str(st.session_state.lg),
    # unsafe_allow_html=True)
>>>>>>> b9fef77fb56aacfc9967baa8cc5a993328bdd0f8
